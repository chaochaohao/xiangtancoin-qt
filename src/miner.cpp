...
void StakeMiner(CWallet *pwallet)
{
    ...
    RenameThread("xiangtancoin-miner");
...
{
    printf("CPUMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("CPUMiner");
    ...
    try { while (true) {
        ...
        printf("Running CPUMiner with %llu transactions in block (%u bytes)\n", pblock->vtx.size(),
        ...
        while (true)
        {
            ...
            pblock->nNonce = pblock->nNonce + 10;
