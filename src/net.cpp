...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("xiangtancoin-ext-ip");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("xiangtancoin-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "xiangtancoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("xiangtancoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("xiangtancoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("xiangtancoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("xiangtancoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. xiangtancoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("xiangtancoin-start");
